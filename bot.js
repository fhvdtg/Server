...
msg => )
msg.guild.channels.get('771710273455259649').send({embed: {
color: 3447003,
author: {
...
client.on('guildMemberAdd', member => {
    member.roles.add(member.guild.roles.cache.find(i => i.name === 'Prison'))
...
var role = member.guild.roles.find('name', 'Prisoner'); // Variable to get channel ID
member.addRole(role); // Adds the default role to members

member.guild.channels.get('771710273455259649').send({embed: {
color: 3447003,
